...
xrandr --output $DESK_DISPLAY_PRI --mode $PRI_RES --rate 60 --scale-from $PRI_RES --primary --pos 0x0
xrandr --output $DESK_DISPLAY_SEC --mode $SEC_RES --rate 60 --scale-from $SEC_RES --pos 2560x240 
